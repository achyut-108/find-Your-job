...
public enum ErrorCodes {
  ...
  JOB_DOES_NOT_EXIST("FYJ_ERROR_608","Job is invalid or it is no longer active"),
  ...
  JOB_APPLICATION_DOES_NOT_EXIST("FYJ_ERROR_613","Job application is invalid or it is no longer active");
